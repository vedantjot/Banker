...
public class Home extends AppCompatActivity {
    ...
    TabLayout tabLayout;
    TabItem accounts,investments,bills;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accounts=findViewById(R.id.homeTabAccounts);
        investments=findViewById(R.id.homeTabInvestments);
        bills=findViewById(R.id.homeTabBills);
